...
var AbstractReference = (function () {
    ...
    AbstractReference.prototype.set = function (newValue) {
        ...
        if (!this.isResolved)
            throw new Error("Illegal state"); // TODO  find out: is this a problem?
        this.unregisterRef();
...
var ByIdReference = (function (_super) {
    ...
    ByIdReference.prototype.set = function (newValue) {
        if (newValue) {
            ...
            but otherwise this would be a subtle bug people good run into easily. */
            if (!newValue.unit)
                throw new Error("Cannot update property of '" + this.owner.typeName + "', the given object is not yet part of a unit. Please add the object to an unit first");
        }
    ...
    ByIdReference.prototype.assertValueHasSameUnit = function () {
        ...
        if (currentValue && currentValue.unit && this.owner.unit && currentValue.unit !== this.owner.unit)
            throw new Error("In element of type " + this.owner.typeName + ": The assigned value should be part of the same unit, expected '" + this.owner.unit.id + "' but found '" + currentValue.unit.id + "'.");
    };
    ...
    ByIdReference.prototype.resolve = function () {
        if (!this.isResolved) {
            ...
            if (!this.referenceId) {
                ...
                throw new Error("encountered null ID: unitID=" + this.owner.unit.id + "; ID of element containing by-id reference property: ID=" + this.owner.id);
            }
            else {
            ...
            this.isResolved = true; // Resolving a by-id always succeeds, (unless not, then it throws ;-))
        }
        return true;
    };
...
var ByNameReference = (function (_super) {
    ...
    function ByNameReference(owner, targetType) {
