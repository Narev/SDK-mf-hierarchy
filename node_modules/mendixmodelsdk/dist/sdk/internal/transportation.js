...
var RestTransportation = (function () {
    ...
    RestTransportation.prototype.request = function (method, url, data, success, failure) {
        ...
        this.handleRequest(restler[method](url, options), url, data, function (responseData, response) { return success(responseData); }, failure);
    };
    RestTransportation.prototype.requestMultipartBinaryFileUpload = function (method, url, data, fileParameterName, filename, success, failure) {
        var method = this.sanitizedMethod(method);
        var url = this.url(url);
        var options = this.generateStandardOptions();
